...
function Login() {
    ...
    const { email,password}=formData   //This line uses object destructuring to extract the individual attributes (name, email, password, and password2) from the formData object. After this line, you can use these variables directly instead of accessing them through formData.name, formData.email, etc.
